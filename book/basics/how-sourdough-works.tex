...
environment, the faster the yeast's metabolism works. The variety of yeast
...
chances are your yeast prefer a colder environment.

As an example, beer makers discovered a beneficial yeast living in the cold
caves around the city of Pilsen, Czech Republic. This yeast has been known to
produce excellent tasting beers at lower temperatures, and varieties of these
strains are now used to make popular lager beers.
...
cultivated by the leaves of plants, though very little is known about why this
is the case.
...
water, the air, or other animals. Some even feed from the honeydew produced by
aphids or pollen that lands on the surface of the leaves. Such organisms are
called \textit{epiphytes}, and included among them are the types of yeast we
use for baking.
...
Indeed, there is some research showing that some plants intentionally release
compounds such as sugars, organic acids, amino acids, methanol, and various
...
best interest of the epiphytes to keep the plants on which they dwell alive
...
harmless to humans. The yeasts would grow and multiply on the leaves on the
plant, esentially shielding them from other types of mold. This could be a
potential game changer for vineyards that suffer from mildew.
...
shows how crucial yeasts could be in protecting our crops. First, they would
make tiny incisions into some of the grapes on a vine. Then, they would infect
the wounds with mold. Some incisions would only be infected by mold. Others
would also be innoculated with some of the 150 different wild yeast strains
isolated from the leaves. They found that when the wound was innoculated with
yeast, the grape sustained no significant damage \cite{yeasts+biocontrol+agent}.

Interestingly, there was another experiment that showed how brewer's yeast
could function as an aggressive pathogen to grape vines. Initially, the yeast
lived in symbiosis with the plants, but after the vines sustained heavy damage,
the yeast became opportunistic and started attacking them, even producing
hyphae, the mycellium network usually associated with a fungus, to deeply
penetrate the tissue of the plants.
