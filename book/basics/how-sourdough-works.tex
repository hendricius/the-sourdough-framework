...
Just as amylase breaks down starches into simple sugars, protease breaks down
complex proteins into simpler proteins and amino acids. Because wheat contains
gluten, a protein that's essential to the structure of bread, proteases
necessarily play a crucial role in the baking of good sourdough.

Because the grain seeds require smaller amino acids to build roots and other
...
the same process inevitably occurs in bread dough.

If you've ever tried to make a wheat-based dough and kept it at room
temperature for several days, you'll have discovered that the gluten network
eventually breaks down, so that the dough can no longer hold together. Once
this happens, the dough can be torn apart and is no longer suitable for baking
bread.
...
gluten network started to break down. The root cause for this issue was
protease.

By adding water to your dough, you activate the protease enzyme, which then
gets to work in readying amino acids for the germ.

Another interesting experiment that viusalises
