...
\begin{figure}[!htb]
\centering
  \includegraphics[width=1.0\textwidth]{injera-pancake-texture}
...
\begin{figure}[htb]
\centering
  \includegraphics[width=1.0\textwidth]{einkorn-crumb}
...
\begin{figure}[!htb]
\centering
  \includegraphics[width=0.85\textwidth]{free-standing-loaf}
