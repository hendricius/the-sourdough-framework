\begin{tikzpicture}
  ...
  \draw[line width=1pt] (\timelinewidth/2,0) -- (\timelinewidth/2 +\segmentwidth/3,0);
  \draw[line width=1pt] (\timelinewidth/2+\segmentwidth/3-5,-0.2) -- (\timelinewidth/2+\segmentwidth/3+5, 0.2);
