\begin{tikzpicture}[node distance = 3cm, auto]
  ...
  \node [block, below of=feed_no_branch, texd width=7em, node distance=3cm] (feed_yes_branch)
  ...
  \path [line] (decision_start) -- node[anchor=south, left=2pt] {yes} ++(0, -3.2) |- (feed_yes_branch);
  ...
  \path [line] (smell_check) -- node[anchor=north, left=2pt] {no} ++(0, 3.2) |- (feed_yes_branch);
