...
we kids couldn't help it. Mom would cut for us a few slices straight from the oven, and we would
...
So over the years, as we became friends with the owners and would receive
...
to the pizza sauce. We ended up in a ending cycle of experiments. However, we never managed
to get close to the experience we had while on vacation.

Some years passed, and I began my studies in the small German city of Göttingen.
...
to do my own deep dive to understand what was happening. Much to my surprise, however,
...
should I slap my dough while kneading on the counter? Why is a standmixer
...
Why should one recipe use wheat while another used rye or spelt? And how often should the
...
the perfect tool for documenting my recipes, because my recipes, too, would change with each
subsequent iteration. Much to my surprise, my open source work on sourdough has been appreciated
by many other engineers. The project became popular on the website GitHub, originally built to
...
(https://ko-fi.com/thebreadcode). The community's feedback has been amazing thus far, and
...
bit of money, but the digital version will remain completely free.
...
a thousand times in a lab environment, which I haven't done. I will do my best, however, to provide
scientific references where possible and clearly distinguish between facts and personal opinion.
