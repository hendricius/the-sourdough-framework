...
maintenance for your starter? As explained earlier your starter is adapt
...
long period of time (SOURCE). The acidity of your sourdough starter is quite
...
Scientists have found 150 million year old yeast spores (SOURCE). While being spores
they are howevever more vulnerable to external pathogens such as mold. But as
the whole starter is very they live in a protected environment.
Other fungi have a hard time decomposing your left over starter mass.
I have seen only very few cases where the starter actually died. It is almost impossible
to kill a starter. What
happens though is that the balance of yeast and bacteria changes in your
starter. The bacteria is more adapt to living in the acidic environment. This
is a problem when you make another dough. You want to have the proper balance
of fluffness and sour notes. When a starter has hibernated for a long period
...
part drying out. As mold is aerobic it can not survive under water (SOURCE,
PICTURE). The colder it is the longer you preserve a good balance of yeast and
bacteria. Below 4°C the starter fermentation comes to a complete halt
(SOURCE).
